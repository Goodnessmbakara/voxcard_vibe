...
const contractCode = readFileSync('./voxcard-stacks/contracts/voxcard-savings-v6.clar', 'utf8');

// Deployment configuration
const contractName = 'voxcard-savings-v6';
...
console.log('🚀 Deploying VoxCard Savings Contract to Stacks Testnet...\n');
