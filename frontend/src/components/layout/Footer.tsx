  ...
  return (
	<footer className="relative bg-gradient-to-tr from-vox-primary to-vox-secondary text-white pt-10 pb-6 mt-8">
		...
		<div className="flex flex-col items-center md:items-start mb-6 md:mb-0">
			...
			<span className="mt-2 text-vox-accent font-sans font-semibold text-sm tracking-wide">Save Safe, Win Sure.</span>
			<p className="text-gray-200 mt-2 max-w-xs text-center md:text-left text-sm">
		...
		<div className="mb-6 md:mb-0">
			...
			<li><a href="/groups" className="text-gray-200 hover:text-white transition-colors">Saving Groups</a></li>
			<li><a href="/community" className="text-gray-200 hover:text-white transition-colors">Community</a></li>
			<li><a href="/support" className="text-gray-200 hover:text-white transition-colors">Support</a></li>
			</ul>
		</div>
		<div className="flex flex-col items-center md:items-end">
			...
			{socialLinks.map((link, idx) => (
				...
				className="text-white hover:text-vox-accent focus:outline-none"
				>
				{link.icon}
				</motion.a>
			))}
			</div>
			<span className="text-xs text-gray-200">&copy; {new Date().getFullYear()} VoxCard. All rights reserved.</span>
		</div>
		</div>
		<motion.div
