...
const contractCode = readFileSync('./voxcard-stacks/contracts/voxcard-savings-v7.clar', 'utf8');

// Deployment configuration
const contractName = 'voxcard-savings-v7';
...
console.log('🚀 Deploying VoxCard Savings v7 (Fixed Pagination) to Stacks Testnet...\n');
...
async function deployContract() {
  try {
    ...
    console.log('\n🎉 Contract v7 deployed successfully!');
    ...
    console.log(`\n🔧 Fix Applied: Resolved ArithmeticUnderflow error in get-paginated-group-ids function`);
    console.log(`\n📝 Next Steps:`);
    console.log(`   1. Update frontend .env file with new contract name: ${contractName}`);
    console.log(`   2. Test the frontend to ensure groups are now visible`);
    console.log(`   3. Verify pagination works correctly`);
